...
include 'DBConnection.php';
  ...
  $dbcon->DBConnectionData();
  	...
  	$seller_info_id=$_POST['seller_info_id'];
  	...
  	$array=$dbcon->sellerEdit($seller_info_id,$seller_name,$seller_comp_name,$seller_mobile_no,$seller_address,$seller_join_date,$seller_remark);
?>